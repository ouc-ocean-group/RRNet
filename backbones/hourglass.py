...
class Hourglass(nn.Module):
    ...
    def _hour_glass_forward(self, n, x):
        ...
        up2 = F.interpolate(low3, size=up1.size()[-2:])
        out = up1 + up2
        return out
    ...
    def forward(self, x):
        ...
        for i in range(self.num_stacks):
            ...
            if i < self.num_stacks - 1:
                fc_ = self.fc_[i](y)
                # TODO: there are still some issue.
...
def hourglass_net(num_stacks=2, num_blocks=4, num_classes=16):
    """
    Make Hourglass Net.
    :param num_stacks: number of stacked blocks.
    :param num_blocks: number of blocks.
    :param num_classes: Useless in our project.
    :return: model
    """
