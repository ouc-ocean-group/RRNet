...
class SwapCell(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        if x1_path_idx == x2_path_idx and x1_layer_idx == x2_layer_idx:
            x = x1_feat
        else:
